package com.ihealthink.ks.system.config.aspect;
...
/**
 * @author xiaoyang
 * @description: 方法访问时间日志记录
 * @date:  Created in 18:01 2022/4/1
 */
@Aspect
@Configuration
public class ServiceLogAspect {
    ...
    @Around("execution(* com.ihealthink.ks.system.service.impl.*.*(..))")
